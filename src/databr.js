...
export function QRCodeDataBlockReader(blocks,  version,  numErrorCorrectionCode)
{
	this.blockPointer = 0;
	this.bitPointer = 7;
	this.dataLength = 0;
	...
	this.getDataLength=function( modeIndicator)
		{
			...
			return this.getNextBits(this.qrcode.sizeOfDataLengthInfo[this.dataLengthMode][index]);
		}
